...
data_2005 = spark.sql("SELECT AAPL_adjClose, \
     ...
     FULL JOIN deltabase.zion_30min_delta ON AAPL_dateTime = ZION_dateTime \
     FULL JOIN deltabase.zts_30min_delta ON AAPL_dateTime = ZTS_dateTime \
     WHERE DATE_FORMAT(AAPL_dateTime,'HHmm') = '1600' and DATE_FORMAT(AAPL_dateTime,'yyyy-MM-dd') between '2005-01-03' and '2005-12-31'\
     ORDER BY AAPL_dateTime asc \
")
...
data_2005_spark_to_pd = data_2005.na.drop().pandas_api()
#data_2005_spark_to_pd = data_2005.pandas_api()

#data_2005_pd = data_2005_spark_to_pd.dropna(axis='columns')

#display(data_2005_spark_to_pd)

# COMMAND ----------

#data_2005_pd_pct = data_2005_pd.pct_change().fillna(0)
data_2005_pd_pct = data_2005_spark_to_pd.pct_change(1)

#display(data_2005_pd_pct)
