...
display(spark.sql("SELECT AAPL_dateTime, AAPL_adjClose FROM deltabase.aapl_30min_delta where DATE_FORMAT(AAPL_dateTime,'HHmm') between '0930' and '1630'"))
...
data.write.format("delta").mode("overwrite").option("overwriteSchema","True").saveAsTable(S&P500_adjClose_NormalTradingHours_30min_delta)
