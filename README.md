...
## Description
1. Provide over 2 billion historical S&P 500 constituents with high-frequency data rows (no survivorship bias) to different users in Azure Databricks Delta Lake.
